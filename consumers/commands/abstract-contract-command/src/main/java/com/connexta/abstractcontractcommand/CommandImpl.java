...
public class CommandImpl implements Action {
    ...
    private Calculator<AbstractWrapper> calculator;

    private Consumer<AbstractWrapper> consumer;
    ...
    private void initServices() throws InvalidSyntaxException {
        ...
        calculator = getService(Calculator.class, "(id=abstract-contract)");
        consumer = getService(Consumer.class, "(id=by-abstract-contract)");
    }
