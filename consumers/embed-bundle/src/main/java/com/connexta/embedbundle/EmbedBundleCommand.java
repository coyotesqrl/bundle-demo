...
import com.connexta.ccalc.CalcImpl;

@Command(scope = "bundle", name = "embedbundle", description = "Don't embed bundles.")
public class EmbedBundleCommand extends OsgiCommandSupport {
